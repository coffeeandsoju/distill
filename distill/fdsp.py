...
class LanguageModel(L.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        # return bnb.optim.Adam8bit(self.parameters(), lr=0.01, eps=1e-4)
        return bnb.optim.Adam8bit(self.parameters(), lr=0.001, eps=1e-4)
...
trainer = L.Trainer(accelerator="cuda", devices=2, strategy="ddp", precision="16-true")
